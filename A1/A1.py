...
class A1:
    ...
    def train(self):
        ...
        acc_train, clf = train_model(self.x_train, self.y_train, 'A1', 'LinearSVM')

        # Train RandomForest classifier without feature selection
        # acc_train, clf = train_model(self.x_train, self.y_train, 'A1', 'RandomForest')
        ...
        #     self.x_train, self.y_train, 'A1', 'LinearSVM')

        # Train RandomForest classifier after feature selection
        # acc_train, clf = train_model(
        #     self.x_train, self.y_train, 'A1', 'RandomForest')
    ...
    def test(self, clf):
        ...
        #     clf, self.x_test, self.y_test, ['Male', 'Female'])
